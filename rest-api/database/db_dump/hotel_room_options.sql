...
CREATE TABLE `room_options` (
  ...
  `opname` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `room_options` VALUES (1,'TV'),(2,'Balcony'),(3,'Air conditioner'),(4,'Trash view'),(5,'Sea view'),(6,'Pool view');
